...
const BookCard = ({ book, isNewPath = false }) => {
  ...
  return (
    <motion.div 
      ...
      className="bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-2xl cursor-pointer transition-all duration-300 group flex flex-col h-full"
    >
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t border-slate-50">
          ...
          <Link to={path} className="text-blue-600 hover:text-blue-700 transition-colors">
