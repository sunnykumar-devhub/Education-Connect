    ...
    <div className="min-h-screen bg-slate-50 pt-24 sm:pt-32 pb-20 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 sm:mb-16 border-b-2 border-slate-100 pb-8 sm:pb-10">
          ...
          <div className="flex items-center gap-2 text-slate-400 text-[8px] sm:text-[10px] font-black uppercase tracking-widest">
            <Link to="/" className="hover:text-[#0F172A]">Library</Link>
            <ChevronRight className="w-3 h-3" />
            <span className="text-[#3B82F6]">{displayTitle}</span>
          </div>
        </div>
